...
export default function CreativeProjectsPage() {
  ...
  const [taskId, setTaskId] = useState('detail_hero');
  ...
  async function createProject() {
    ...
    try {
      ...
      navigate(`/creative-projects/${project.id}?welcome=1`);
